...
import { proRegister } from "../../../store/actions/pro";
    ...
    return (
      <SafeAreaView style={styles.safeAreaView}>
        <KeyboardAwareScrollView
          ...
          contentContainerStyle={styles.proRegisterScrollView}
        >
